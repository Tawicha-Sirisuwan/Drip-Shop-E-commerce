  ...
  return (
    <main className="flex-1 flex flex-col justify-center items-center py-12 sm:py-24 px-4 bg-white">
      ...
      <div className="w-full max-w-md">
        ...
        <button className="w-full border border-gray-300 bg-white text-black rounded-full py-3.5 mt-8 font-medium hover:bg-gray-50 transition-colors flex items-center justify-center gap-3 cursor-pointer">
        ...
        <p className="text-center text-sm text-[#666666] mt-10">
          ...
          <Link href="/login" className="text-black font-medium underline hover:text-gray-600 transition-colors">
            Sign In
          </Link>
        </p>
      </div>
